...
main() {
    ...
    echo ""
    echo "Next steps:"
    echo "  1. Sign in with your ChatGPT account (recommended):"
    echo "     smart-scribe login"
    echo ""
    echo "     Or, to use a metered OpenAI API key instead:"
    echo "     smart-scribe config set auth api_key"
    echo "     smart-scribe config set openai_api_key sk-..."
    echo ""
    echo "  2. Test it:"
